...
class NoInput : public ::Ice::UserExceptionHelper<NoInput, ::Ice::UserException>
{
public:

    virtual ~NoInput();

    NoInput(const NoInput&) = default;
...
/// \cond INTERNAL
static NoInput _iceS_NoInput_init;
/// \endcond
...
class NoInput : public ::Ice::UserException
{
public:
     ...
     */
    virtual NoInput* ice_clone() const;
    /**
...
template<>
struct StreamableTraits< ::Demo::NoInput>
{
